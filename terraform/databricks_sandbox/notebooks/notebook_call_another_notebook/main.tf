...
resource "databricks_notebook" "run_write_emp_data" {
  ...
  path     = "${data.databricks_current_user.me.home}/terraform_notebooks/notebook_call_another_notebook/run_write_emp_data"
  language = "PYTHON"
}
...
resource "databricks_notebook" "write_emp_data" {
  ...
  path     = "${data.databricks_current_user.me.home}/terraform_notebooks/notebook_call_another_notebook/write_emp_data"
  language = "PYTHON"
}