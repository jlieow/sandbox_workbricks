...
resource "databricks_notebook" "_view_data" {
  ...
  path     = "${data.databricks_current_user.me.home}/terraform_notebooks/delta_live_tables/sample_medallion_pipeline/_view_data"
  language = "SQL"
}
...
resource "databricks_notebook" "_00_setup" {
  ...
  path     = "${data.databricks_current_user.me.home}/terraform_notebooks/delta_live_tables/sample_medallion_pipeline/00_setup"
  language = "SQL"
}
...
resource "databricks_notebook" "_01_dlt" {
  ...
  path     = "${data.databricks_current_user.me.home}/terraform_notebooks/delta_live_tables/sample_medallion_pipeline/01_dlt"
  language = "PYTHON"
}

resource "databricks_notebook" "_02_add_incremental_data" {
  content_base64 = filebase64("data/02_add_incremental_data.sql")
  path     = "${data.databricks_current_user.me.home}/terraform_notebooks/delta_live_tables/sample_medallion_pipeline/02_add_incremental_data"
  language = "SQL"
}
